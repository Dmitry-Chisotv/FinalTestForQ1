...
"Омск", "Уфа", "Москва", "Рим", "Милан", "Бар" - [ Уфа, Рим, Бар ]

Решение задачи
Первоначальный массив вводися либо с клавиатуры, либо он задан на старте, о чем спрашивается в начале запуска программы.
...
При вводе No первоначальный массив имеет значение: ["Омск", "Уфа", "Москва", "Рим", "Милан", "Бар"]
